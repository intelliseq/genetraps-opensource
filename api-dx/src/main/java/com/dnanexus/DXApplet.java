...
public class DXApplet extends DXDataObject implements DXExecutable<DXJob> {
    ...
    protected DXApplet(String appletId, String className, DXContainer project, DXEnvironment env, JsonNode describe) {
        super(appletId, className, project, env, describe);
    }
    ...
    public DXApplet(String appletId, String className, DXEnvironment env) {
        super(appletId, className, env, null);
    }
